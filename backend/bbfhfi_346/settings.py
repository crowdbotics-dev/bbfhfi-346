"""
Django settings for bbfhfi_346 project.
...
WSGI_APPLICATION = 'bbfhfi_346.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bbfhfi_346 API",
    "DESCRIPTION": "API documentation for bbfhfi_346 App",
    "VERSION": "v1",
}
